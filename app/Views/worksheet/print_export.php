...
<body>
    ...
    <!-- Informasi PEB -->
    <div class="section-title">Informasi PEB</div>
    <table class="info-table">
        <tr>
            <td>Pengurusan PEB</td>
            <td colspan="3"><?= $ws['pengurusan_peb'] ?></td>
        </tr>
        <tr>
            <td>No Aju</td>
            <td><?= $ws['no_aju'] ?></td>
