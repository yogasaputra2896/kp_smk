...
<div class="card shadow-sm p-4">
    <form action="<?= base_url('worksheet/export/update/' . $worksheet['id']) ?>" method="post">
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                <label>Nama Shipper / Exportir</label>
                <input type="text" name="consignee" class="form-control" value="<?= esc($worksheet['shipper']) ?>">
            </div>
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" name="shipper" class="form-control" value="<?= esc($worksheet['consignee']) ?>">
            </div>
        ...
        <!-- ================= INFORMASI PEB ================= -->
        <br>
        <h5 class="mt-4 mb-3 text-primary fw-bold border-bottom border-primary pb-2">Informasi PEB</h5>
        <div class="row">
            <div class="col-md-6 mb-3">
                <label>Pengurusan PEB</label>
                <select name="pengurusan_peb" class="form-select">
                    <option value="">-- Pilih Pengurusan PEB --</option>
                    <option value="Pembuatan Draft PEB" <?= $worksheet['pengurusan_peb'] === 'Pembuatan Draft PEB' ? 'selected' : '' ?>>Pembuatan Draft PEB</option>
                    <option value="Draft PEB Sendiri" <?= $worksheet['pengurusan_peb'] === 'Draft PEB Sendiri' ? 'selected' : '' ?>>Draft PEB Sendiri</option>
                </select>
            </div>

            <div class="col-md-6 mb-3">
                <label>Nomor Pengajuan PEB</label>
                <input type="text" name="no_aju" class="form-control" value="<?= esc($worksheet['no_aju']) ?>">
            </div>

            <div class="col-md-6 mb-3">
                <label>Tanggal Pengajuan PEB</label>
                <input type="date" name="tgl_aju" class="form-control" value="<?= esc($worksheet['tgl_aju']) ?>">
            </div>

            <div class="col-md-6 mb-3">
                <label>Nomor Pendaftaran PEB</label>
                <input type="text" name="peb_nopen" class="form-control" value="<?= esc($worksheet['peb_nopen']) ?>">
            </div>

            <div class="col-md-6 mb-3">
                <label>Tanggal Pendaftaran PEB</label>
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                    <label>Penjaluran PEB</label>
                    <select name="penjaluran" id="penjaluran" class="form-select">
                        <option value="">-- Pilih Penjaluran PEB --</option>
                        <option value="NPE" <?= $worksheet['penjaluran'] === 'NPE' ? 'selected' : '' ?>>NPE</option>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="date" name="tgl_npe" class="form-control" value="<?= esc($worksheet['tgl_npe']) ?>">
                </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                <label>Port Of Discarge (POD)</label>
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" name="depo" class="form-control" value="<?= esc($worksheet['depo']) ?>">
            </div>

            <div class="col-md-6 mb-3">
                <label>Tanggal Stuffing</label>
                <input type="date" name="stuffing" class="form-control" value="<?= esc($worksheet['stuffing']) ?>">
            </div>
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="date" name="closing" class="form-control" value="<?= esc($worksheet['closing']) ?>">
            </div>
        </div>
        ...
        <div class="mt-4 d-flex justify-content-between align-items-center">
            <div>
                <a href="<?= base_url('/worksheet?type=export') ?>" class="btn btn-secondary">
...
<script>
   ...
   // =============== Tombol Cek Data (kode asli tetap + tambahan loading) ===================
    document.getElementById('checkDataBtn').addEventListener('click', function(e) {
        ...
        fetch(`<?= base_url('worksheet/export/update/') ?>${id}`, {
                method: 'POST',
                body: formData
            })
            .then(response => {
            ...
            .then(() => fetch(`<?= base_url('worksheet/checkExport/') ?>${id}`))
