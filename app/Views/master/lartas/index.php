...
<?= $this->section('title') ?>Master Lartas<?= $this->endSection() ?>

<!-- ====================== HEADER ====================== -->
<?= $this->section('pageTitle') ?>
<div class="page-heading">
    <h3 class="heading-title">Master Data Lartas</h3>

    <p class="text-subtitle text-muted">
        Master Data Lartas digunakan untuk menyimpan informasi Lartas.
...
<div class="card">
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table id="tblLartas" class="table table-striped table-bordered w-100">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Kode</th>
    ...
    <div class="modal-dialog modal-lg">
        <form id="formAdd" class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title">Tambah Lartas</h5>
            ...
            <div class="modal-body">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="kode" id="kodeLartas" class="form-control select2" required></select>
                        <span id="kodeWarning" class="text-danger mt-1" style="display:none;">Kode sudah terdaftar!</span>
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">Nama Lartas</label>
                        <select name="nama_lartas" id="namaLartas" class="form-control select2" required></select>
...
<div class="modal fade" id="modalEdit" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <form id="formEdit" class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title">Edit Lartas</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            ...
            <div class="modal-body">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <label class="form-label">Kode</label>
                        <select name="kode" id="editKodeLartas" class="form-control select2" required></select>
                        <span id="editKodeWarning" class="text-danger mt-1" style="display:none;">Kode sudah terdaftar!</span>
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">Nama Lartas</label>
                        <select name="nama_lartas" id="editNamaLartas" class="form-control select2" required></select>
...
<script src="<?= base_url('assets/js/pages/master/lartas.js') ?>"></script>
<?= $this->endSection() ?>