...
<?= $this->section('title') ?>Master Kemasan<?= $this->endSection() ?>

<!-- ====================== HEADER ====================== -->
<?= $this->section('pageTitle') ?>
<div class="page-heading">
    <h3 class="heading-title">Master Data Kemasan</h3>

    <p class="text-subtitle text-muted">
        Master Data Kemasan digunakan untuk menyimpan informasi Kemasan.
...
<div class="card">
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table id="tblKemasan" class="table table-striped table-bordered w-100">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Kode</th>
            ...
            <div class="modal-body">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="kode" id="kodeKemasan" class="form-control select2" required></select>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="jenis_kemasan" id="jenisKemasan" class="form-control select2" required></select>
                        <span id="namaWarning" class="text-danger mt-1" style="display:none;">Jenis sudah terdaftar!</span>
                    </div>
                </div>
            </div>
        ...
        <form id="formEdit" class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <label class="form-label">Kode</label>
                        <select name="kode" id="editKodeKemasan" class="form-control select2" required></select>
                        <span id="editKodeWarning" class="text-danger mt-1" style="display:none;">Kode sudah terdaftar!</span>
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">Jenis Kemasan</label>
                        <select name="jenis_kemasan" id="editJenisKemasan" class="form-control select2" required></select>
                        <span id="editNamaWarning" class="text-danger mt-1" style="display:none;">Jenis sudah terdaftar!</span>
                    </div>
...
<script src="<?= base_url('assets/js/pages/master/kemasan.js') ?>"></script>
<?= $this->endSection() ?>